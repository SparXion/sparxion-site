...
export type SoftwareBandV2Props = {
...
export const SoftwareBandV2 = forwardRef<BandStripHandle, SoftwareBandV2Props>(function SoftwareBandV2(
  {
    visible,
    seamPx,
    maxRevealPx,
  ...
  const clip = (() => {
    if (seamOutsideWedgeRange || !visible || rightSeamPx === undefined) return 'none';
    return buildHeroSoftwareBandClipPathPx(shellRef.current, rightSeamPx);
  })();
